...
export function apply(ctx, config = {}) {
	...
	ctx.logger.info(
		`[team] dsh-team-workflow 已加载：审计=${auditConfig.enabled} rtk=${rtk.active} lens=${lens.enabled} lens工具=${lensTools.enabled} context7=${context7.enabled} 交接=${handoff.enabled}`,
	);
}
